# Dive Buddy · Scuba (DiveScuba) — Install Guide
...
4. Done — leave the watch alone: it activates itself within 10 minutes (the code disappears) and dive data appears within ~10-20 minutes after a dive
