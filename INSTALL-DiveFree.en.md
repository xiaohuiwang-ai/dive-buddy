...
**🌍 International**: download from the [GitHub repo](https://github.com/xiaohuiwang-ai/dive-buddy) (`DiveFree-分享版.prg` in the root)

**🇨🇳 China (faster)**: open in browser → **https://watch.xiaohuiwangai.cn/dl/DiveFree.prg** (auto-downloads)

You'll get `DiveFree.prg` — save it to your computer.
